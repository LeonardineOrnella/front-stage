...
import { Eye, EyeOff, Mail, Lock, AlertCircle, CheckCircle, BookOpen, ArrowLeft } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/90 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-emerald-100">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-2xl hover:border-emerald-300 hover:bg-emerald-50/50 transition-all duration-200 group"
              >
                ...
                <span className="text-sm font-medium text-gray-600 group-hover:text-emerald-700">Google</span>
              </button>
              <button
                type="button"
                className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-2xl hover:border-emerald-300 hover:bg-emerald-50/50 transition-all duration-200 group"
              >
                ...
                <span className="text-sm font-medium text-gray-600 group-hover:text-emerald-700">Facebook</span>
              </button>
            </div>
